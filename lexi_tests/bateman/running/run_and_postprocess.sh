...
output_dir="/mnt/c/Users/arlenlex/Documents/liggghts_data/bateman/simulations/$rel_sim_folder"
...
if [ -f "$output_dir/atoms_sample.nc" ]; then
    rm "$output_dir/atoms_sample.nc"
    echo "Deleted existing 'atoms_sample.nc' file."
fi
...
python_script_path="$script_dir/dump2netcdf2.py"
