...
for packing in poly10_1 poly10_2 poly20_1 poly20_2; do #already ran mono1, mono2, so only rerunning poly runs. add mono1 and 2 back.
    ...
    # Step 4: Run in.bond
    sed "s|read_data .*|read_data data/${packing}.data|; s|variable poly .*|variable poly equal $poly_value|; \
    ...
    # Step 5: Run in.compress #; s|write_restart .*|write_restart restarts/${packing}_final.restart|
