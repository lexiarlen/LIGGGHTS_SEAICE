...
experiment_name="friction"
processors_install=1  
processors_load=4
packing="ji_mesh2"

for mu in 0.1 0.6 1.0 1.5 3; do
    echo "RUNNING PACKING: $packing with friction coefficient: $mu"

    # Step 1: Create output directory
    variant="friction_${mu}"
    ...
    sed "s|read_restart .*|read_restart restarts/${variant}.restart|; s|variable mu .*|variable mu equal $mu|; \
