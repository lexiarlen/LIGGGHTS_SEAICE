...
experiment_name="restitution"
processors_install=1  
processors_load=4
packing="ji_mesh2"

for e in 0.1 0.3 0.5 0.8; do
    ...
    sed "s|read_restart .*|read_restart restarts/${variant}.restart|; s|variable coeff_rest .*|variable coeff_rest equal $e|; \
